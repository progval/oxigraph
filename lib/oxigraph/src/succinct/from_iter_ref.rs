//! Backport from https://github.com/WanderLanz/Lender/blob/2d7ffab5f3f21a5f3064724aa9063e808ad8e11f/lender/src/fallible_sources/from_iter_ref.rs

use fallible_iterator::{DoubleEndedFallibleIterator, FallibleIterator};
use lender::{DoubleEndedFallibleLender, FallibleLend, FallibleLender, FallibleLending};
